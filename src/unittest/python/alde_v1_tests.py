...
#
# Unit tests that checks ALDE REST API
#
...
class AldeV1Tests(TestCase):
    ...
    def test_patch_execution_preprocessor(self, mock_executor_stop, mock_executor_cancel, mock_executor_add, mock_executor_remove):
        """
